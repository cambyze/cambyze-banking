...
class PersistenceApplicationTests {
  ...
  void testPersonServices() {
    ...
    Person pe = null;
    pe = persistenceServices.findPersonByid(pers);
    LOGGER.debug("Find Pers by ID: ({})", pers);
    assertTrue(pe != null);
    pe = null;
    LOGGER.debug("Find Pers by ID: ({}) test NULL", "0");
    assertTrue(pe == null);
    // pe = null;
    // pe = persistenceServices.findPersonByMail(pers);
    // LOGGER.debug("Find Pers by MAIL: ({})", pers);
    // assertTrue(pe == null);
