...
public class SavingsLimitReachedException extends RuntimeException {
   ...
   */
  public SavingsLimitReachedException(String message) {
    super(message);
  }
   ...
   */
  public SavingsLimitReachedException(PersistEntity entity) {
